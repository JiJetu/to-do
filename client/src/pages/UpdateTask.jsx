...
const UpdateTask = () => {
  ...
  const { _id, taskTitle, description, dateline, reward, category, location } =
    task || {};
  const { user } = useAuth();
  const [startDate, setStartDate] = useState(new Date(dateline) || new Date());
  ...
  const handleUpdateTask = async (e) => {
    ...
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/task/${_id}`, taskData);
